...
public class TaquinFxApplication extends FxApplication {
  public FXMLLoader doApplicationStart(final Stage stage) {
    try {
      String simpleName = TaquinFxApplication.class.getSimpleName();
      String _replaceAll = TaquinFxApplication.class.getPackage().getName().replaceAll("\\.", "/");
